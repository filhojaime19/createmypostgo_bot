...
# Token do bot fornecido pelo BotFather (substitua pelo seu token)
...
def main() -> None:
    ...
    conv_handler = ConversationHandler(
        ...
        states={
            ...
            SETTING_LINK: [
                MessageHandler(filters.TEXT & ~filters.COMMAND, set_link)
            ],
        },
        fallbacks=[
            CommandHandler("start", start),
            CallbackQueryHandler(finalize_or_edit),
        ],
    )
